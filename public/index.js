...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('About').addEventListener('click', () => loadStaticContent('/about'));
    document.getElementById('Terms').addEventListener('click', () => loadStaticContent('/terms'));
    document.querySelectorAll('.a_menu:not(#About):not(#Terms)').forEach(button => {
